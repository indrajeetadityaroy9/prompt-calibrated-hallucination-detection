...
# CUDA_VISIBLE_DEVICES=0 python -m experiments.main \
#     --config experiments/configs/benchmarks/sota_selfcheck.yaml
...
CUDA_VISIBLE_DEVICES=0 python -m experiments.main \
    --config experiments/configs/generalization/cross_dataset.yaml
...
CUDA_VISIBLE_DEVICES=0 python -m experiments.main \
    --config experiments/configs/generalization/long_context.yaml
...
CUDA_VISIBLE_DEVICES=0 python -m experiments.main \
    --config experiments/configs/architecture/qwen.yaml
...
python -m experiments.main \
    --config experiments/configs/scaling/model_size_sweep.yaml
...
python -m experiments.main \
    --config experiments/configs/architecture/mixture_of_experts.yaml
